...
def parser():
    ...
    parser.add_argument(
        '--input', 
        type=str, 
        default='/mnt/ly/models/FinalTerm/CV/video/keyframe_Phase_based/magnified_5x', 
        help='input folder')
    parser.add_argument(
        '--output', 
        type=str, 
        default='/mnt/ly/models/FinalTerm/CV/video/keyframe_Phase_based/output_video_5x.mp4', 
